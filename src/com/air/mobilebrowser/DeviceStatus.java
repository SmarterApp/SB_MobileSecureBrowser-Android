...
import com.air.mobilebrowser.NetworkReceiver.NetworkStatusHandler;
...
{ 
			...
			if(tts.isLanguageAvailable(locale) == TextToSpeech.LANG_AVAILABLE);
			{
				...
				if(!langs.contains(isoLanguage))
				{
					...
					try 
					{
						...
						voice.put("language", locale.getISO3Language());
						available.put(voice);
	...
	public String getStartTime() {
		...
		SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-FF HH:mm:ss z");
